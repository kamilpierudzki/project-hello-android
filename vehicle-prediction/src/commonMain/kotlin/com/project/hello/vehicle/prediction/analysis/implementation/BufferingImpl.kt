...
class BufferingImpl(private val synchronization: Synchronization) : Buffering {
    ...
    override fun bufferedLine(
        ...
        return synchronization.synchronized(this) {
            ...
            return@synchronized calculatedResultWithProbability()
        }
    }
