package com.project.hello.settings.internal.ui
...
internal class SettingsFragment : Fragment() {
    ...
    private fun goToCityPickerScreen(view: View) {
        val action = SettingsFragmentDirections.goToCityPickerScreen(false)
    ...
    private fun setupBinding() {
        val currentlySelectedTransitAgency: TransitAgency? =
            cityPickViewModel.currentlySelectedTransitAgency
