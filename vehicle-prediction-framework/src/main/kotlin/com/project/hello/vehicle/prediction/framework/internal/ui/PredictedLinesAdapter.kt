...
internal class PredictedLinesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PredictedLineViewHolder {
        ...
        return PredictedLineViewHolder(binding, predictionScreenContentDescription)
    }
