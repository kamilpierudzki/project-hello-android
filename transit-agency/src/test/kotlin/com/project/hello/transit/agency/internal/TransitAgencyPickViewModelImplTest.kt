package com.project.hello.transit.agency.internal
...
internal class TransitAgencyPickViewModelImplTest {
    ...
    fun `when currentlySelectedCityEvent changes currentlySelectedCity is available`() =
        coroutinesTestRule.testDispatcher.runBlockingTest {
            ...
            // when
            tested.currentlySelectedTransitAgencyEvent.postValue(
                Event(
                    TransitAgencySelection.Selected(
                        cityA
                    )
                )
            )
